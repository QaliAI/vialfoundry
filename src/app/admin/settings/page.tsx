  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <form onSubmit={handleSave} className="glass-panel p-6 rounded-2xl border border-white/10 space-y-6 font-mono text-xs">
        ...
        <button
          type="submit"
          className="px-6 py-3 rounded-xl bg-brand-primary text-white font-display font-bold text-xs hover:bg-brand-primary-hover transition-all flex items-center space-x-2 shadow-lg"
        >
